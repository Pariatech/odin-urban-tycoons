...
layout(location = 3) in float left_border_width;
layout(location = 4) in float right_border_width;
layout(location = 5) in float top_border_width;
layout(location = 6) in float bottom_border_width;
