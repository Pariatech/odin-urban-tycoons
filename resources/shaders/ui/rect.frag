...
layout(location = 3) in float frag_left_border_width;
layout(location = 4) in float frag_right_border_width;
layout(location = 5) in float frag_top_border_width;
layout(location = 6) in float frag_bottom_border_width;
